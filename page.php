<?php
  ...
  while(have_posts()) {
    ...
    <!-- SHOWS THE SIDEBAR'S LINKS MENU ONLY IF THE PAGE IS A PARENT PAGE OR A CHILDREN PAGE -->
    <?php
    // CHECK IF A PAGE IS A PARENT PAGE
    // IF GET_PAGES() RETURN SOMETHING, THAT'S A PARENT PAGE, ELSE IT WILL RETURN 0
    ...
    <div class="page-links">
      <!-- IF $THEPARENT RETURNS ZERO, GET_THE_TITLE() WILL KNOW THAT WE'RE SEARCHING FOR THE TITLE OF THE CURRENT PAGE, OR IT WILL GET THE CHILD PAGE TITLE -->
